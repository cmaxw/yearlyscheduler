...
(function() {
  ...
  Calendar = {
    ...
    completeSelection: function(finish) {
      var start;
      start = this.selectedElements[0];
      if (this.selectedElements.length > 1) {
        this.clearSelection();
        this.select(start);
        return this.completeSelection(finish);
      } else {
        return this.selectRange(start, finish);
      }
    },
    selectRange: function(start, finish) {
      var current_day, current_month, el, finish_day, finish_month, start_day, start_month, temp, _results, _results1;
      ...
      if (start_month === finish_month) {
        ...
        while (current_day <= finish_day) {
          ...
          _results1.push(current_day += 1);
        }
        return _results1;
      }
    },
    colorize: function(color) {
      var el, hexcolor, _i, _j, _len, _len1, _ref, _ref1;
      _ref = this.selectedElements;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        el = _ref[_i];
        el = $(el);
    ...
    persistDateAs: function(year, month, day, color) {
    ...
    unlabelSelection: function() {
      var el, hexcolor, _i, _j, _len, _len1, _ref, _ref1, _results;
      _ref = this.selectedElements;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        el = _ref[_i];
        ...
        el.removeClass("selected");
        _results.push(this.persistDateAs(el.data("year"), el.data("month"), el.data("day"), null));
      }
      return _results;
    },
    editLabel: function(e) {
      ...
      color = $(e).data("color");
      if (!color) {
        color = $(e).parent().data("color");
      }
      $("#label-" + color + " .label-text").hide();
      return $("#label-" + color + " .label-form").show();
    }
  };
  ...
  $(document).ready(function() {
    $('.calendar-day').click(function(e) {
      if (e.shiftKey && Calendar.selectedElements.length > 0) {
        return Calendar.completeSelection(e.target);
      } else {
        Calendar.clearSelection();
        return Calendar.select(e.target);
      }
    });
    $('.label-button').click(function(e) {
      var color;
      color = $(e.currentTarget).attr('id').replace("label-", "");
      return Calendar.colorize(color);
    });
    $('#label-clear').click(function(e) {
      return Calendar.unlabelSelection();
    });
    $('.label-edit').click(function(e) {
      return Calendar.editLabel(e.target);
    });
    return $('.label-form form :text').keypress(function(e) {
      var color, form, pair, _i, _j, _len, _len1, _ref, _ref1;
      if (e.which === 13) {
        e.preventDefault();
        ...
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          pair = _ref1[_j];
          if (pair.name === 'name') {
            $("#label-" + color + " .label-text").html(pair.value);
          }
        }
